...
public class P004_MergeSortedArray {
	...
	//space - > O[1]
	//Time - > n log N 
	public static void MergeSortedArrayBruteForce(int[] nums1, int m, int[] nums2, int n) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		MergeSortedArrayBruteForce(new int[] {1,2,3,0,0,0}, 6, new int[] {2,5,6}, 3);
		MergeSortedArrayBruteForce(new int[] {0,0,0}, 3, new int[] {0}, 1);
	}
