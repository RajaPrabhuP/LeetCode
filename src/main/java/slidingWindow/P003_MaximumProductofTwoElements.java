...
public class P003_MaximumProductofTwoElements {
...
Command-line arguments:  -os win32 -ws win32 -arch x86_64 -product org.eclipse.epp.package.java.product
	...
	*/
	...
	public static int MaximumProductofTwoElementsArrayList(int[] arr){
		...
		for(int i = 0; i < alist.size(); i++) {
			...
			for(int j = i + 1; j < alist.size() - 1; j++) {
				...
				mul = (alist.get(i) - 1) * (alist.get(j) - 1);
	...
	public static void main(String[] args) {
		...
		System.out.println(MaximumProductofTwoElementsArrayList(new int[] {1,2,10,9,8}));
		System.out.println(MaximumProductofTwoElementsArrayList(new int[] {1, 1}));
		System.out.println(MaximumProductofTwoElementsArrayList(new int[] {9,9,9,9,9,9,9,9}));
